...
export const UI_TEXT = {
  es: {
    ...
    roomServiceError: "No se pudo conectar con las salas. Revisa el despliegue y vuelve a intentarlo.",
    back: "Volver",
    leave: "Salir",
    ...
    bots: "Bots",
    botsInMatch: "Bots en partida",
    noBots: "Sin bots",
    hostOnlyStart: "Solo el lider puede empezar la partida.",
    waitingForLeader: "Esperando a que el lider empiece...",
    yourCat: "Tu gato",
    ...
    controlsJump: "Saltar / doble salto",
    controlsAttack: "Click para atacar / disparar hacia el raton",
  ...
  en: {
    ...
    roomServiceError: "Could not connect to rooms. Check the deployment and try again.",
    back: "Back",
    leave: "Leave",
    ...
    bots: "Bots",
    botsInMatch: "Bots in match",
    noBots: "No bots",
    hostOnlyStart: "Only the leader can start the match.",
    ...
    controlsMove: "Move",
    controlsJump: "Jump / double jump",
    controlsAttack: "Click to attack / aim shots at mouse",
